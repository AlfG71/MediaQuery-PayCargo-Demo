...
const Book = require("../models/Content.model");

const MONGO_URI = process.env.MONGODB_URI || "mongodb://localhost/MediaQuery";
...
Content.create(videos)
  .then((videosFromDB) => {
    console.log(`Created ${videosFromDB.length} books`);
